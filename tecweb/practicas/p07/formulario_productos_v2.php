...
<html>
    ...
    <body>
        <h1 align="center">Registra Nuevos Peluches</h1>
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li><label>Marca: </label>
                        <ul>
                            <li><label>MATTEL<input type="radio" id="form-marca" name="form-marca" value="MATTEL"></input></label></li>
                            <li><label>AURORA<input type="radio" id="form-marca" name="form-marca" value="AURORA"></input></label></li>
                            <li><label>DISNEY STORE<input type="radio" id="form-marca" name="form-marca" value="DISNEY STORE"></input></label></li>
                            <li><label>TY<input type="radio" id="form-marca" name="form-marca" value="TY"></input></label></li>
                            <li><label>MARVEL<input type="radio" id="form-marca" name="form-marca" value="MARVEL"></input></label></li>
                            <li><label>JAZWARES<input type="radio" id="form-marca" name="form-marca" value="JAZWARES"></input></label></li></br>
                        </ul>
                    </li>
        ...
        <h1 align="center">Modifica Peluches</h1>
        ...
        <form id="formularioModProductos" onsubmit="return validar2()" action="http://localhost/tecnologiasWeb/practicas/p07/set_producto_v3.php" method="post">
            ...
            <fieldset>
                <legend>Peluche Existente</legend>
                <ul>
                    <li><label>Nombre: <input type="text" id="form-name2" name="form-name2" value="<?=$_POST['nombre-form']?>"></input></label></li></br>
                    <li><label>Marca: </label>
                        <ul>
                            <li><label>MATTEL<input type="radio" id="form-marca2" name="form-marca2" value="MATTEL"></input></label></li>
                            <li><label>AURORA<input type="radio" id="form-marca2" name="form-marca2" value="AURORA"></input></label></li>
                            <li><label>DISNEY STORE<input type="radio" id="form-marca2" name="form-marca2" value="DISNEY STORE"></input></label></li>
                            <li><label>TY<input type="radio" id="form-marca2" name="form-marca2" value="TY"></input></label></li>
                            <li><label>MARVEL<input type="radio" id="form-marca2" name="form-marca2" value="MARVEL"></input></label></li>
                            <li><label>JAZWARES<input type="radio" id="form-marca2" name="form-marca2" value="JAZWARES"></input></label></li></br>
                        </ul>
                    </li>
